...
MPC::MPC() {} /* Constructior */
MPC::~MPC() {} /* Destructior */

/**
 * @brief 
 * 
 * @param x0  - Initial State [x,y,ψ,v,cte,eψ]
 * @param coeffs - coeffs are the coefficients of the fitting polynomial
...
std::vector<double> MPC::Solve(const VectorXd &x0, const VectorXd &coeffs) {
  ...
  size_t n_states = N * 6;
  size_t n_actuators = (N - 1) * 2;
  size_t n_vars = n_states + n_actuators;
