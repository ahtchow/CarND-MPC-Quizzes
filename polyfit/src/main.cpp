...
int main() {
   ...
   */
  auto coefficients = polyfit(xvals, yvals, 4);
  ...
  for (int i = 0; i < xvals.size(); ++i) {
    ...
    /* Lets see how well it estimate the values */
    double y = polyeval(coefficients, xvals[i]);
    std::cout << "Actual:" << y << " , Estimate:" << yvals[i] << std::endl; 
  }
